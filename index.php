...
<body><script src="https://code.jquery.com/jquery-2.1.0.min.js" ></script>
<script>
...
<form id="form" method="POST" action="./resume.php">
    <div class="logo">
    ...
    <div class="form-item">
			...
			<input type="text" name="Fullname" id="email" class="form-style" autocomplete="off"/>
    </div>

    <div class="form-item">
			<p class="formLabel">Age</p>
			<input type="number" name="Age" id="email" class="form-style" autocomplete="off"/>
    </div>

    <div class="form-item">
			<p class="formLabel">Email</p>
			<input type="email" name="Emailadress" id="email" class="form-style" autocomplete="off"/>
    </div>


    <div class="form-item">
			<p class="formLabel">Adresse</p>
			<input type="text" name="AdressHome" id="email" class="form-style" autocomplete="off"/>
    </div>

    <div class="form-item">
			<p class="formLabel">Telephone</p>
			<input type="number" name="tele" id="email" class="form-style" autocomplete="off"/>
    </div>
